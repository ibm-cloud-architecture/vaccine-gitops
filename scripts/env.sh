...
SCHEMA_REGISTRY_URL=https://{KAFKA_CLUSTER_NAME}-ibm-es-ac-reg-external-${KAFKA_NS}.assets-arch-eda-6ccd7f378ae819553d37d5f2ee142bd6-0000.us-east.containers.appdomain.cloud
